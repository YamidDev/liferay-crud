...
import com.yamidev.virtualclassroom.exception.NoSuchCourseSessionException;
import com.yamidev.virtualclassroom.model.CourseSession;
import com.yamidev.virtualclassroom.model.impl.CourseSessionImpl;
import com.yamidev.virtualclassroom.model.impl.CourseSessionModelImpl;
...
public class CourseSessionPersistenceImpl
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, CourseSessionImpl.class, primaryKey);
		}
	}
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.yamidev.virtualclassroom.model.CourseSession"),
			true);
	}
