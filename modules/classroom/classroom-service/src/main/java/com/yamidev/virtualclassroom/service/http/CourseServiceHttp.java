...
public class CourseServiceHttp {
	...
	public static com.yamidev.virtualclassroom.model.Course addCourse(
		...
		try {
			...
			return (com.yamidev.virtualclassroom.model.Course)returnObj;
		}
	...
	public static java.util.List<com.yamidev.virtualclassroom.model.Course>
		findByGroupId(HttpPrincipal httpPrincipal, long groupId) {

		try {
			MethodKey methodKey = new MethodKey(
				CourseServiceUtil.class, "findByGroupId",
				_findByGroupIdParameterTypes1);
			...
			return (java.util.List<com.yamidev.virtualclassroom.model.Course>)
				returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException
					systemException) {
	...
	private static final Class<?>[] _findByGroupIdParameterTypes1 =
