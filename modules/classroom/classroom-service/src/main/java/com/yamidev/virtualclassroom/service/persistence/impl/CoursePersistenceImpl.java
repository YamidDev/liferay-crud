...
import com.yamidev.virtualclassroom.exception.NoSuchCourseException;
import com.yamidev.virtualclassroom.model.Course;
import com.yamidev.virtualclassroom.model.impl.CourseImpl;
import com.yamidev.virtualclassroom.model.impl.CourseModelImpl;
...
public class CoursePersistenceImpl
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.yamidev.virtualclassroom.model.Course"),
			true);
	}
