...
/**
 * Provides the local service interface for BusinessAsset. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BusinessAssetLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BusinessAssetLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BusinessAssetLocalServiceUtil} to access the Activos del negocio local service. Add custom service methods to <code>com.yamidev.virtualclassroom.service.impl.BusinessAssetLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
