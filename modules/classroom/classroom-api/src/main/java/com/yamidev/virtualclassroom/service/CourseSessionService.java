...
public interface CourseSessionService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CourseSessionServiceUtil} to access the course session remote service. Add custom service methods to <code>com.yamidev.virtualclassroom.service.impl.CourseSessionServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
