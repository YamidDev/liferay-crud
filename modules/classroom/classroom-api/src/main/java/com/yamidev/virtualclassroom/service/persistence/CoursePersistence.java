...
public interface CoursePersistence extends BasePersistence<Course> {
	 ...
	 */
	public java.util.List<Course> findByUserId(long userId);
	 ...
	 */
	public java.util.List<Course> findByUserId(long userId, int start, int end);
	 ...
	 * @return the matching courses
	 */
	public java.util.List<Course> findByU_G(long userId, long groupId);
