...
package com.pactia.co.active.service.persistence.impl;
...
import com.pactia.co.active.model.impl.BusinessAssetImpl;
import com.pactia.co.active.model.impl.BusinessAssetModelImpl;
import com.pactia.co.active.service.persistence.BusinessAssetPersistence;
import com.pactia.co.active.service.persistence.impl.constants.psPersistenceConstants;
...
/**
 * The persistence implementation for the business asset service.
 *
 * <p>
...
public class BusinessAssetPersistenceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>BusinessAssetUtil</code> to access the business asset persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	@Override
	public List<BusinessAsset> findByUserId(long userId) {
	 ...
	 */
	@Override
	public List<BusinessAsset> findByUserId(long userId, int start, int end) {
	 ...
	 */
	@Override
	public List<BusinessAsset> findByUserId(
	...
	public List<BusinessAsset> findByUserId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (BusinessAsset businessAsset : list) {
					if (userId != businessAsset.getUserId()) {
						list = null;
	...
	public BusinessAsset findByUserId_First(
		...
		BusinessAsset businessAsset = fetchByUserId_First(
	...
	public BusinessAsset fetchByUserId_First(
		...
		List<BusinessAsset> list = findByUserId(
	...
	public BusinessAsset findByUserId_Last(
		...
		BusinessAsset businessAsset = fetchByUserId_Last(
			userId, orderByComparator);
	...
	public BusinessAsset[] findByUserId_PrevAndNext(
		...
		try {
			...
			array[0] = getByUserId_PrevAndNext(
				session, businessAsset, userId, orderByComparator, true);

			array[1] = businessAsset;

			array[2] = getByUserId_PrevAndNext(
				session, businessAsset, userId, orderByComparator, false);
	...
	protected BusinessAsset getByUserId_PrevAndNext(
		Session session, BusinessAsset businessAsset, long userId,
		OrderByComparator<BusinessAsset> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<BusinessAsset> findByGroupId(long groupId) {
	 ...
	 */
	@Override
	public List<BusinessAsset> findByGroupId(long groupId, int start, int end) {
	 ...
	 */
	@Override
	public List<BusinessAsset> findByGroupId(
	...
	public BusinessAsset findByGroupId_First(
		...
		BusinessAsset businessAsset = fetchByGroupId_First(
	...
	public BusinessAsset fetchByGroupId_First(
		...
		List<BusinessAsset> list = findByGroupId(
	...
	public BusinessAsset findByGroupId_Last(
		...
		BusinessAsset businessAsset = fetchByGroupId_Last(
			groupId, orderByComparator);
	...
	protected BusinessAsset getByGroupId_PrevAndNext(
	 ...
	 */
	@Override
	public List<BusinessAsset> findByU_G(long userId, long groupId) {
		return findByU_G(
	 ...
	 */
	@Override
	public List<BusinessAsset> findByU_G(
	...
	public BusinessAsset findByU_G_First(
		...
		BusinessAsset businessAsset = fetchByU_G_First(
	...
	public BusinessAsset fetchByU_G_First(
		...
		List<BusinessAsset> list = findByU_G(
	...
	public BusinessAsset findByU_G_Last(
		...
		BusinessAsset businessAsset = fetchByU_G_Last(
			userId, groupId, orderByComparator);
	...
	public BusinessAsset[] findByU_G_PrevAndNext(
		...
		try {
			...
			array[0] = getByU_G_PrevAndNext(
				session, businessAsset, userId, groupId, orderByComparator,
				true);
	...
	protected BusinessAsset getByU_G_PrevAndNext(
		Session session, BusinessAsset businessAsset, long userId, long groupId,
		OrderByComparator<BusinessAsset> orderByComparator, boolean previous) {
	...
	/**
	 * Clears the cache for all business assets.
	 *
	 * <p>
	...
	/**
	 * Clears the cache for the business asset.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	 ...
	 * Removes the business asset with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the business asset
	 * @return the business asset that was removed
	 * @throws NoSuchBusinessAssetException if a business asset with the primary key could not be found
	 */
	@Override
	...
	public BusinessAsset updateImpl(BusinessAsset businessAsset) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {businessAssetModelImpl.getUserId()};
			...
			args = new Object[] {
				businessAssetModelImpl.getUserId(),
				businessAssetModelImpl.getGroupId()
			};
			...
			if ((businessAssetModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					businessAssetModelImpl.getOriginalUserId()
				};
	...
	/**
	 * Returns the business asset with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the business asset
	...
	/**
	 * Initializes the business asset persistence.
	 */
	@Activate
	public void activate() {
		...
		_finderPathWithoutPaginationFindByUserId = new FinderPath(
			...
			BusinessAssetModelImpl.USERID_COLUMN_BITMASK);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.pactia.co.active.model.BusinessAsset"),
			true);
	}
	...
	static {
		try {
			Class.forName(psPersistenceConstants.class.getName());
		}
